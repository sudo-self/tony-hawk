...
You can host the gamefile online, if so then you would just change where the emulator looks to load from. It is currently set to root so you would just swap out the "tb.bin" in quotes with the URL of your ps1 game.
